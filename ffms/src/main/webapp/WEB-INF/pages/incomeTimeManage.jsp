...
window.onload=function(){
	 var s_incomer = '${c_username}';
	var s_starttime = $("#s_starttime").datetimebox("getValue");
	var s_endtime = $("#s_endtime").datetimebox("getValue");
	$.post("${basePath}produceIncomeTime.do", 
			//,username:"${currentUser.username}"
			{incomer : s_incomer,starttime:s_starttime,endtime:s_endtime}, 
			function(result) {
	...
	function searchLine(){
		var s_incomer = '${currentUser.username }';
		var s_starttime = $("#s_starttime").datetimebox("getValue");
		var s_endtime = $("#s_endtime").datetimebox("getValue");
		...
		$.post("${basePath}produceIncomeTime.do", 
				//,username:"${currentUser.username}"
				{incomer : s_incomer,starttime:s_starttime,endtime:s_endtime,name:"${currentUser.username}"}, 
				function(result) {
			$('#containerLine').highcharts({
		        chart: {
		            type: 'spline'
