...
function() {
	...
	function(r, n, t) {
		...
		e = function(r) {
			...
			function o(r) {
				for (var n = 0,
				t = 0; t < r.length; t++) n += r[t];
				return n
			}
			function a(r, n) {
				for (var t = 0,
				e = 0; e < r.length; e++) t += r[e][n];
				return t
			}
			function u(r, n) {
	...
	function(r, n, t) {
		...
		e = function(r) {
			function n(r) {
				...
				var n = [],
				t = a(r);
				if (1 === t.length) for (var e = 0; e < t[0]; e++) i(r[e]) && n.push(r[e]);
				else if (2 === t.length) for (var e = 0; e < t[0]; e++) {
					for (var u = !0,
					f = 0; f < t[1]; f++) i(r[e][f]) || (u = !1);
					u && n.push(r[e])
				}
				return n
			}
	...
	function(r, n, t) {
		...
		e = function(r) {
			function n(r) {
				for (var n = 1 / 0,
				t = 0; t < r.length; t++) o(r[t]) && r[t] < n && (n = r[t]);
				return n
			}
			var e = t(1),
			o = e.isNumber;
	...
	function(r, n, t) {
		...
		e = function(r) {
			...
			function o(r, t, o) {
				function a() {
					if (E < t) {
						...
						for (var r, e, o, a = 0; a < x.length; a++) {
							...
							q = h(w),
							A + q < y && (y = q + A, r = a, e = N.centroids, o = N.clusterAssigned)
						}
				...
				for (var f, v = i(r), p = l(v), d = c(p[0], 2), M = e(v), x = [M], m = 0; m < p[0]; m++) f = u(v[m], M),
				d[m][1] = g(f, 2);
				var y, b, w, N, A, q, E = 1,
				j = {
					isEnd: !1
			...
			function a(r, n) {
				for (var t, e, o, a = l(r), u = c(n, a[1]), i = 0; i < a[1]; i++) {
					t = r[0][i],
					e = r[0][i];
					for (var f = 1; f < a[0]; f++) r[f][i] < t && (t = r[f][i]),
					r[f][i] > e && (e = r[f][i]);
					o = e - t;
			...
			function u(r, n) {
				...
				for (var t = 0,
				e = 0; e < r.length; e++) t += g(r[e] - n[e], 2);
				return p(t)
			}
			var i = t(4),
			f = t(3),
	...
	function(r, n, t) {
		...
		e = function(r) {
			function n(r, n) {
				...
				for (var t = i(r), a = e(t), u = o(t), f = n(t, u, a), l = v(u, a, f), g = h(Math.ceil(u / l) * l, Math.floor(a / l) * l, l), d = g.length, M = new Array(d + 1), x = 0; x <= d; x++) M[x] = {},
				M[x].sample = [],
			...
			p = {
				...
				freedmanDiaconis: function(r, n, t) {
					return r.sort(l),
					Math.ceil((t - n) / (2 * (a(r, .75) - a(r, .25)) * Math.pow(r.length, -1 / 3)))
				},
				sturges: function(r) {
		...
		e = function(r) {
			function n(r, n) {
				for (var t = 0; t < r.length - 1; t++) {
					for (var e = t,
					o = t + 1; o < r.length - 1; o++) Math.abs(r[t][o]) > Math.abs(r[t][e]) && (e = o);
				...
				for (var l = new Array(n), s = r.length - 1, o = r.length - 2; o >= 0; o--) {
					for (var u = 0,
					t = o + 1; t < r.length - 1; t++) u += r[t][o] * l[t];
					l[o] = (r[s][o] - u) / r[o][o]
				}
				return l
			}
			...
			o = {
				linear: function(r) {
					for (var n = e(r), t = 0, o = 0, a = 0, u = 0, i = n.length, f = 0; f < i; f++) t += n[f][0],
					o += n[f][1],
					a += n[f][0] * n[f][1],
					u += n[f][0] * n[f][0];
				...
				linearThroughOrigin: function(r) {
					for (var n = e(r), t = 0, o = 0, a = 0; a < n.length; a++) t += n[a][0] * n[a][0],
					o += n[a][0] * n[a][1];
					for (var u = o / t,
					i = [], f = 0; f < n.length; f++) {
						var l = [n[f][0], n[f][0] * u];
				...
				exponential: function(r) {
					for (var n = e(r), t = 0, o = 0, a = 0, u = 0, i = 0, f = 0, l = 0; l < n.length; l++) t += n[l][0],
					o += n[l][1],
					f += n[l][0] * n[l][1],
					a += n[l][0] * n[l][0] * n[l][1],
					...
					for (var s = o * a - f * f,
					h = Math.pow(Math.E, (a * u - f * i) / s), c = (o * i - f * u) / s, v = [], p = 0; p < n.length; p++) {
				...
				logarithmic: function(r) {
					for (var n = e(r), t = 0, o = 0, a = 0, u = 0, i = 0; i < n.length; i++) t += Math.log(n[i][0]),
				...
				polynomial: function(r, t) {
					...
					for (var a = [], u = [], i = t + 1, f = 0; f < i; f++) {
						for (var l = 0,
						s = 0; s < o.length; s++) l += o[s][1] * Math.pow(o[s][0], f);
						u.push(l);
						for (var h = [], c = 0; c < i; c++) {
							for (var v = 0,
							p = 0; p < o.length; p++) v += Math.pow(o[p][0], f + c);
							h.push(v)
						}
						a.push(h)
					}
					...
					for (var g = n(a, i), d = [], f = 0; f < o.length; f++) {
						for (var M = 0,
						s = 0; s < g.length; s++) M += g[s] * Math.pow(o[f][0], s);
						d.push([o[f][0], M])
					}
					for (var x = "y = ",
					f = g.length - 1; f >= 0; f--) x += f > 1 ? Math.round(g[f] * Math.pow(10, f + 1)) / Math.pow(10, f + 1) + "x^" + f + " + ": 1 === f ? Math.round(100 * g[f]) / 100 + "x + ": Math.round(100 * g[f]) / 100;
					return {
						points: d,
						parameter: g,
						expression: x
	...
	function(r, n, t) {
		...
		e = function(r) {
			return function(r, n, t) {
				...
				a = e / o;
				return a >= Math.sqrt(50) ? o *= 10 : a >= Math.sqrt(10) ? o *= 5 : a >= Math.sqrt(2) && (o *= 2),
				n >= r ? o: -o
			}
		}.call(n, t, n, r),
		!(void 0 !== e && (r.exports = e))
